// attack
#[path = "attack/all_for_one.rs"] mod all_for_one;
#[path = "attack/all_out_attack.rs"] mod all_out_attack;
#[path = "attack/anger.rs"] mod anger;
#[path = "attack/bash.rs"] mod bash;
#[path = "attack/bludgeon.rs"] mod bludgeon;
#[path = "attack/body_slam.rs"] mod body_slam;
#[path = "attack/carnage.rs"] mod carnage;
#[path = "attack/clash.rs"] mod clash;
#[path = "attack/cleave.rs"] mod cleave;
#[path = "attack/clothesline.rs"] mod clothesline;
#[path = "attack/dramatic_entrance.rs"] mod dramatic_entrance;
#[path = "attack/feed.rs"] mod feed;
#[path = "attack/fiend_fire.rs"] mod fiend_fire;
#[path = "attack/flash_of_steel.rs"] mod flash_of_steel;
#[path = "attack/hand_of_greed.rs"] mod hand_of_greed;
#[path = "attack/heavy_blade.rs"] mod heavy_blade;
#[path = "attack/hemokinesis.rs"] mod hemokinesis;
#[path = "attack/immolate.rs"] mod immolate;
#[path = "attack/iron_wave.rs"] mod iron_wave;
#[path = "attack/mind_blast.rs"] mod mind_blast;
#[path = "attack/perfected_strike.rs"] mod perfected_strike;
#[path = "attack/pommel_strike.rs"] mod pommel_strike;
#[path = "attack/pummel.rs"] mod pummel;
#[path = "attack/reaper.rs"] mod reaper;
#[path = "attack/reckless_charge.rs"] mod reckless_charge;
#[path = "attack/ritual_dagger.rs"] mod ritual_dagger;
#[path = "attack/searing_blow.rs"] mod searing_blow;
#[path = "attack/strike.rs"] mod strike;
#[path = "attack/swift_strike.rs"] mod swift_strike;
#[path = "attack/sword_boomerang.rs"] mod sword_boomerang;
#[path = "attack/thunderclap.rs"] mod thunderclap;
#[path = "attack/twin_strike.rs"] mod twin_strike;
#[path = "attack/uppercut.rs"] mod uppercut;
#[path = "attack/whirlwind.rs"] mod whirlwind;
#[path = "attack/wild_strike.rs"] mod wild_strike;
// skill
#[path = "skill/apotheosis.rs"] mod apotheosis;
#[path = "skill/armaments.rs"] mod armaments;
#[path = "skill/bandage_up.rs"] mod bandage_up;
#[path = "skill/blind.rs"] mod blind;
#[path = "skill/bloodletting.rs"] mod bloodletting;
#[path = "skill/burning_pact.rs"] mod burning_pact;
#[path = "skill/chrysalis.rs"] mod chrysalis;
#[path = "skill/dark_shackles.rs"] mod dark_shackles;
#[path = "skill/deadly_poison.rs"] mod deadly_poison;
#[path = "skill/deep_breath.rs"] mod deep_breath;
#[path = "skill/defend.rs"] mod defend;
#[path = "skill/disarm.rs"] mod disarm;
#[path = "skill/enlightenment.rs"] mod enlightenment;
#[path = "skill/entrench.rs"] mod entrench;
#[path = "skill/finesse.rs"] mod finesse;
#[path = "skill/flex.rs"] mod flex;
#[path = "skill/forethought.rs"] mod forethought;
#[path = "skill/ghostly_armor.rs"] mod ghostly_armor;
#[path = "skill/good_instincts.rs"] mod good_instincts;
#[path = "skill/impatience.rs"] mod impatience;
#[path = "skill/impervious.rs"] mod impervious;
#[path = "skill/intimidate.rs"] mod intimidate;
#[path = "skill/jack_of_all_trades.rs"] mod jack_of_all_trades;
#[path = "skill/limit_break.rs"] mod limit_break;
#[path = "skill/madness.rs"] mod madness;
#[path = "skill/master_of_strategy.rs"] mod master_of_strategy;
#[path = "skill/metamorphosis.rs"] mod metamorphosis;
#[path = "skill/panacea.rs"] mod panacea;
#[path = "skill/panic_button.rs"] mod panic_button;
#[path = "skill/power_through.rs"] mod power_through;
#[path = "skill/purity.rs"] mod purity;
#[path = "skill/second_wind.rs"] mod second_wind;
#[path = "skill/secret_technique.rs"] mod secret_technique;
#[path = "skill/secret_weapon.rs"] mod secret_weapon;
#[path = "skill/seeing_red.rs"] mod seeing_red;
#[path = "skill/sentinel.rs"] mod sentinel;
#[path = "skill/shockwave.rs"] mod shockwave;
#[path = "skill/shrug_it_off.rs"] mod shrug_it_off;
#[path = "skill/spot_weakness.rs"] mod spot_weakness;
#[path = "skill/the_bomb.rs"] mod the_bomb;
#[path = "skill/thinking_ahead.rs"] mod thinking_ahead;
#[path = "skill/transmutation.rs"] mod transmutation;
#[path = "skill/trip.rs"] mod trip;
#[path = "skill/true_grit.rs"] mod true_grit;
#[path = "skill/violence.rs"] mod violence;
#[path = "skill/warcry.rs"] mod warcry;
// power
#[path = "power/barricade.rs"] mod barricade;
#[path = "power/berserk.rs"] mod berserk;
#[path = "power/brutality.rs"] mod brutality;
#[path = "power/combust.rs"] mod combust;
#[path = "power/dark_embrace.rs"] mod dark_embrace;
#[path = "power/demon_form.rs"] mod demon_form;
#[path = "power/evolve.rs"] mod evolve;
#[path = "power/feel_no_pain.rs"] mod feel_no_pain;
#[path = "power/fire_breathing.rs"] mod fire_breathing;
#[path = "power/inflame.rs"] mod inflame;
#[path = "power/juggernaut.rs"] mod juggernaut;
#[path = "power/mayhem.rs"] mod mayhem;
#[path = "power/panache.rs"] mod panache;
#[path = "power/rupture.rs"] mod rupture;
#[path = "power/sadistic_nature.rs"] mod sadistic_nature;
// curse
#[path = "curse/ascenders_bane.rs"] mod ascenders_bane;
#[path = "curse/curse_of_the_bell.rs"] mod curse_of_the_bell;
#[path = "curse/decay.rs"] mod decay;
#[path = "curse/doubt.rs"] mod doubt;
#[path = "curse/injury.rs"] mod injury;
#[path = "curse/normality.rs"] mod normality;
#[path = "curse/pain.rs"] mod pain;
#[path = "curse/parasite.rs"] mod parasite;
#[path = "curse/regret.rs"] mod regret;
#[path = "curse/shame.rs"] mod shame;
#[path = "curse/writhe.rs"] mod writhe;
// status
#[path = "status/burn.rs"] mod burn;
#[path = "status/clumsy.rs"] mod clumsy;
#[path = "status/dazed.rs"] mod dazed;
#[path = "status/slimed.rs"] mod slimed;
#[path = "status/void.rs"] mod void;
#[path = "status/wound.rs"] mod wound;
...
impl Card {
    pub fn def(&self) -> CardDef {
        match self {
            ...
            Card::PanicButton(g)     => panic_button::def(*g),
            ...
            Card::Mayhem(g)          => mayhem::def(*g),
            Card::RitualDagger(n)    => ritual_dagger::def(*n),
            ...
            Card::Pain             => pain::def(),
            Card::Panache(g)       => panache::def(*g),
            Card::Purity(g)        => purity::def(*g),
    ...
    pub fn grade(&self) -> Option<Grade> {
        match self {
            ...
            | Card::Apotheosis(g)
            | Card::Finesse(g) | Card::FlashOfSteel(g) | Card::Forethought(g) | Card::GoodInstincts(g) | Card::HandOfGreed(g) | Card::Impatience(g) | Card::MasterOfStrategy(g) | Card::MindBlast(g) | Card::SwiftStrike(g)
            ...
            | Card::JackOfAllTrades(g) | Card::Panacea(g) | Card::PanicButton(g) | Card::Panache(g) | Card::SadisticNature(g) | Card::TheBomb(g) | Card::Madness(g) | Card::Transmutation(g) | Card::Chrysalis(g) | Card::Metamorphosis(g) | Card::Mayhem(g) => Some(*g),
            Card::SearingBlow(_) | Card::RitualDagger(_) |
    ...
    fn with_grade(&self, g: Grade) -> Card {
        match self {
            ...
            Card::HandOfGreed(_)   => Card::HandOfGreed(g),
            ...
            Card::PanicButton(_)     => Card::PanicButton(g),
            ...
            Card::Mayhem(_)          => Card::Mayhem(g),
            Card::SearingBlow(_) | Card::RitualDagger(_) => unreachable!(),
            Card::Disarm | Card::Normality | Card::Pain | Card::Void | Card::Writhe | Card::Dazed | Card::Slimed | Card::Injury | Card::Clumsy | Card::Decay | Card::Regret |
            Card::Wound | Card::Burn | Card::BurnPlus | Card::Doubt | Card::Shame |
    ...
    pub fn id(&self) -> &'static str {
        match self {
            ...
            Card::HandOfGreed(g)   => hand_of_greed::id(*g),
            ...
            Card::PanicButton(g)     => panic_button::id(*g),
            ...
            Card::Mayhem(g)          => mayhem::id(*g),
            Card::RitualDagger(_)    => ritual_dagger::id(),
    ...
    pub fn from_id(s: &str) -> Option<Card> {
        ...
        let all: &[Card] = &[
            ...
            Card::Mayhem(Base),          Card::Mayhem(Plus),
            Card::RitualDagger(0),
...
pub fn apply(card: &Card, state: &mut crate::combat::CombatState, events: &mut Vec<crate::combat::Event>, target: usize, rng: &mut impl crate::rng::Rng, x_value: i32) {
    match card {
        ...
        Card::HandOfGreed(g)   => hand_of_greed::apply(state, events, *g, target),
        ...
        Card::PanicButton(g)     => panic_button::apply(state, events, *g, rng),
        ...
        Card::Mayhem(g)          => mayhem::apply(state, events, *g),
        Card::RitualDagger(n)    => ritual_dagger::apply(state, events, *n, target),
