...
pub fn apply(state: &mut CombatState, events: &mut Vec<Event>, damage: i32, weak: i32) {
    ...
    apply_status(&mut state.enemy.statuses, Target::Enemy, StatusEffect::Weak, weak, events);
}
