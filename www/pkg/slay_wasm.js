...
export class WasmSession {
     ...
     */
    is_over() {
        const ret = wasm.wasmsession_is_over(this.__wbg_ptr);
        return ret !== 0;
    }
    constructor() {
    ...
    send(input) {
        ...
        try {
            ...
            const ret = wasm.wasmsession_send(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
...
export class WasmTuiSession {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WasmTuiSessionFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmtuisession_free(ptr, 0);
    }
    /**
     * @returns {boolean}
     */
    is_over() {
        const ret = wasm.wasmtuisession_is_over(this.__wbg_ptr);
        return ret !== 0;
    }
    constructor() {
        const ret = wasm.wasmtuisession_new();
        this.__wbg_ptr = ret;
        WasmTuiSessionFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @param {number} cols
    ...
    resize(cols, rows) {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmtuisession_resize(this.__wbg_ptr, cols, rows);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    send(input) {
        ...
        try {
            const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmtuisession_send(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    send_key(key) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmtuisession_send_key(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
if (Symbol.dispose) WasmTuiSession.prototype[Symbol.dispose] = WasmTuiSession.prototype.free;
...
const WasmTuiSessionFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmtuisession_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('slay_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
