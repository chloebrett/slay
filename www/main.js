...
// Write initial render after first fit, then reveal and focus.
term.write(session.send(""));
container.style.visibility = "visible";
term.focus();

// Re-focus the terminal whenever the user clicks anywhere on the page.
